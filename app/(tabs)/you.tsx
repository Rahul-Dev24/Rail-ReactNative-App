...
export default function You() {
    ...
    return (
        <View className="flex-1 bg-white">
            <LinearGradient colors={['#DFF6FB', '#dff6fb8c']} style={{
                ...
                <View className="items-center mt-3">
                    <View className="w-18 h-18 rounded-full bg-sky-400 items-center justify-center">
                        <Ionicons name="person" size={40} color="#BFDBFE" />
                    </View>
                ...
                {/* Wallet card */}
                <View className="mx-6 bg-white rounded-full px-3 py-3 flex-row items-center justify-between shadow-sm">
                    <View className="flex-row items-center">
                        <View className="w-11 h-11 rounded-xl items-center justify-center mr-3">
                            <Fontisto name="wallet" size={24} color="#57C785" />
                        </View>
                        <View>
            ...
            >
                {/* Profile completion */}
                <View className="mx-6 mt-3 border border-sky-100 rounded-2xl px-3 py-2">
                    <Text className="text-slate-800 text-lg mb-1">
                        Profile Incomplete
                    </Text>
                    <View className="flex-row items-center">
                        <View className="flex-1 h-1.5 rounded-full bg-slate-200 overflow-hidden mr-3">
                            <View
                                className="h-2 rounded-full bg-green-600"
                                style={{ width: `${profileCompletion}%` }}
                            />
                        </View>
                        <Text className="text-slate-900 text-lg font-[app-regular]">
                            {profileCompletion}%
                        </Text>
                    </View>
                </View>
                ...
                {/* Verify email banner */}
                <TouchableOpacity
                    className="mx-6 mt-4 bg-red-50 rounded-2xl py-3 items-center"
                    activeOpacity={0.8}
                >
